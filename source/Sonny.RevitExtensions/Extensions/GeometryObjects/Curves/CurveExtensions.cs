...
namespace Sonny.RevitExtensions.Extensions.GeometryObjects.Curves ;
...
public static class CurveExtensions
{
    ...
    public static IEnumerable<Line> GetLines(this IEnumerable<Curve> curves) => curves.OfType<Line>() ;
