...
using Sonny.RevitExtensions.Extensions.GeometryObjects.Faces ;

namespace Sonny.RevitExtensions.Extensions.GeometryObjects.Solids ;
...
public static class SolidCurveExtensions
{
    ...
    public static IEnumerable<Line> GetLines(this IEnumerable<Solid> solids) => solids.SelectMany(x => x.GetLines()) ;
    ...
    public static IEnumerable<Arc> GetArcs(this IEnumerable<Solid> solids) => solids.SelectMany(x => x.GetArcs()) ;
    ...
    public static IEnumerable<Edge> GetEdges(this IEnumerable<Solid> solids) => solids.SelectMany(x => x.GetEdges()) ;
}
