...
const string outputName = "Sonny.RevitExtensions" ;
const string projectName = "Sonny.RevitExtensions" ;
...
var project = new Project
{
  ...
  GUID = new Guid( "57145667-1389-48E2-8DA3-DD2997210FCF" ),
...
project.RemoveDialogsBetween( NativeDialogs.WelcomeDlg,
  NativeDialogs.CustomizeDlg ) ;
...
void BuildMultiUserUserMsi()
{
  ...
  project.Dirs =
  [
    new InstallDir( @"%CommonAppDataFolder%\Autodesk\Revit\Addins\",
      wixEntities )
  ] ;
  project.BuildMsi() ;
}